...
def main():
    ...
    for project in projects:
        for seed in range(10):
            selection_file_path = pathlib.Path(
                "/Users/haradakanon/Downloads/research/200200100/math{project}log/selection.csv".format(project=project))
            file_path = pathlib.Path(
                "/Users/haradakanon/Downloads/research/200200100/math{project}/seed{seed}".format(
                    project=project, seed=str(seed))
            )
            output_file_path = pathlib.Path(
                "/Users/haradakanon/Downloads/research/200200100/math{project}log/correct_patch".format(project=project))
    ...
    for project in projects:
        file_path = pathlib.Path(
            "/Users/haradakanon/Downloads/research/200200100/math{project}log".format(
                project=project)
        )
        summary(file_path)
